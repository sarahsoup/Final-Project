  ...
  d3.select('.btn-default')
      ...
      .on('click',function(d){
        ...
        d3.selectAll('.countryPath')
          .style('stroke', function(d,i){ return hostMatch(d,i) ? '#009F93' : 'black';})
          .style('opacity', function(d,i){ return hostMatch(d,i) ? 1 : 0; });
        ...
        d3.selectAll('.node')
          .style('fill',function(e){
            if(hostYears.has(e.key)) {return '#009F93'}
            else {return '#fff'}
          })
        ...
        d3.selectAll('.labels-city').filter(function(e){if(d == e.noc && e.host == 1){return e}})
        .attr('x',function(e){return scaleX(new Date(e.key))+10})
        .attr('y',function(e){return scaleY(e.value)-25})
        .style('fill','#fff')
        .style('font-weight','bold')
        .text(function(e){return e.city});
        ...
        d3.selectAll('.labels-count').filter(function(e){if(d == e.noc && e.host == 1){return e}})
        .attr('x',function(e){return scaleX(new Date(e.key))+10})
        .attr('y',function(e){return scaleY(e.value)-5})
        .style('fill','#fff')
        .text(function(e){return e.value + ' medals'});
        ...
        d3.select('.country-content').select('p')
        .html(function(){
